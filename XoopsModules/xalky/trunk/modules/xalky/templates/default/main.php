...
<div id="mainContainer" class="mainContainer">
	...
	<img id="roomIcon" class="roomIcon" src="templates/<?php echo $CONFIG['template'];?>/images/rooms.png" alt="" onclick="newRoom('<?php if($_GET['sID']){?>0<?php }else{?>1<?php }?>');">
	...
	<div id="optionsContainer" class="optionsContainer">
		...
		<span class="optionsSelectStatus">
			...
			<span id="iconeCredits" class="iconeCredits" style="cursor:pointer;" onclick='showInfoBox("ecredits","550","600","25","templates/<?php echo $CONFIG['template'];?>/ecredits.php","");'><?php echo C_LANG109;?>: <span id="eCreditsID"></span></span>
		</span>
