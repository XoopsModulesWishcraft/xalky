...
.loginBody
{
	...
	background-image:url('templates/<?php echo $CONFIG['template'];?>/images/background.jpg');	
...
.backgroundContainer
{
    ...
    background: url(<?php echo $CONFIG['loginImage'];?>) no-repeat center center fixed;
	...
	<div id="loginContainer" class="loginContainer">
		...
		<div id="loginRight" class="loginRight">
			...
			<div id="loginButton" class="loginButton">
				<img onclick="hideshow('login')" src="templates/<?php echo $CONFIG['template'];?>/images/loginButton.png" alt="">
			</div>		
			...
			<div id="login" style="display:none;">
				...
				<tr id="lostpass"><td>&nbsp;</td><td><span class="link"><a href="javascript:void(0);" onclick='showInfoBox("lost","260","400","200","templates/<?php echo $CONFIG['template'];?>/lost.php","");'><?php echo C_LANG116;?></a></span></td></tr>
				...
				<tr><td>&nbsp;</td><td><input type="image" style="height:22px;width:140px;" src="templates/<?php echo $CONFIG['template'];?>/images/login.jpg" name="newLogin" alt="Login"></td></tr>		
				<tr><td colspan="2">&nbsp;</td></tr>
				</table>
				</form>
			</div>
			
			<?php if(!$CONFIG['disableRegistration']){?>
				<div id="registerButton" class="registerButton">
					<img onclick="hideshow('register')" src="templates/<?php echo $CONFIG['template'];?>/images/registerButton.png" alt="">
				</div>	
				...
				<div id="register" style="display:none;">			
					...
					<tr><td>&nbsp;</td><td><input class="" type="checkbox" name="terms" value="1"><span class="link"><a href="javascript:void(0);" onclick='showInfoBox("terms","400","600","100","templates/<?php echo $CONFIG['template'];?>/terms.php","");'><?php echo C_LANG123;?></a></span></td></tr>
					<tr><td>&nbsp;</td><td><input type="image" style="height:22px;width:140px;" src="templates/<?php echo $CONFIG['template'];?>/images/register.jpg" name="newRegister" alt="Register"></td></tr>
					</table>
					</form>
				</div>
			<?php }?>
...
<div class='copyright'>
	<?php if($CONFIG['usersOnline']){?>
		<span class="link" style="float:left"><a href="javascript:void(0);" onclick='showInfoBox("online","300","320","100","templates/<?php echo $CONFIG['template'];?>/online.php","");'><?php echo C_LANG113;?>: <?php echo getUsersOnline('1');?></a>&nbsp;</span>
	<?php } ?>
