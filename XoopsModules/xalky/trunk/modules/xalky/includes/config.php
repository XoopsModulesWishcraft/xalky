...
$CONFIG['chatroomName']  = 'Xalky';
$CONFIG['chatroomEmail'] = 'sales@xalky.com';
$CONFIG['chatroomUrl']   = 'http://8.xalky.com/';
...
/*
* url to login page background image
*
*/

$CONFIG['loginImage'] = 'templates/default/images/loginbg.jpg';
...
/*
* show users online on login page
* 
*/

$CONFIG['usersOnline'] = '1'; // 0 No, 1 Yes
...
* for non-integrated chat rooms only
* (admins can add users via admin panel)
*/

$CONFIG['disableRegistration'] = '0'; // 0 No, 1 Yes
...
$CONFIG['intelliBotName'] = 'Intelli-Bot (M)';   
...
$CONFIG['smilies'] = '1'; // 0 Off, 1 On
$CONFIG['ringBell'] = '1'; // 0 Off, 1 On
$CONFIG['textStyles'] = '1'; // 0 Off, 1 On
$CONFIG['userAvatars'] = '1'; // 0 Off, 1 On
$CONFIG['playSFX'] = '1'; // 0 Off, 1 On
$CONFIG['clearScreen'] = '1'; // 0 Off, 1 On
$CONFIG['userSettings'] = '1'; // 0 Off, 1 On
$CONFIG['chatHistory'] = '1'; // 0 Off, 1 On
$CONFIG['chatHelp'] = '1'; // 0 Off, 1 On
...
$CONFIG['moderatedXalkyPlugin'] = '0'; // 0 Off, 1 On
